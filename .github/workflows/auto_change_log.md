...
3. Build commit intelligence context for summary quality:
   ...
   - Group changes into themes inferred from BOTH commit text and changed paths (for example: action/core logic, bug fixes, tests, CI/workflows, docs, dependencies).
